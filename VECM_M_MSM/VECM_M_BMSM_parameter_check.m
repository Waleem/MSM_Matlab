function [data, S, F, kbar, startvals,LB1,UB1,LB2,UB2,n,options] = ...
                                 VECM_M_BMSM_parameter_check(data,S,F,kbar,n, startingvals, options)
...
% -------------------------------------------------------------------------
LB1 = [1,      1,      0.0001, 0.0001, 0.001,  1,  -200,  -200, -200, -200];
UB1 = [1.9999, 1.9999, 200,    200,    0.9999, 200, 200,   200,  200,  200];
LB2 = [-0.9999, 0.0001];
UB2 = [ 0.9999, 0.9999];
